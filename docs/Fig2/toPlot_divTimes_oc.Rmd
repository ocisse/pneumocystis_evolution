...
#colBars<-c( plasma(10)[1], plasma(10)[3], plasma(10)[5], plasma(10)[7])
...
#colBars <- c("black", "black", "black", "black", "black", "black", "black", "black", "black", "black", "black", "black", "black")

#pdf(file="compare_mamPhy_cladeDivTimes_plot95CI_oc.pdf",height=7,width=16,onefile=TRUE)
svg(file="compare_mamPhy_cladeDivTimes_plot95CI_oc.svg", ,height=5,width=12,onefile=TRUE)
	...
	#plotCI(y=rev(1:length(divTimes$height_median)), x= -divTimes$height_median, ui= -divTimes$height_95._HPD_MIN, li= -divTimes$height_95._HPD_MAX, err="x",
	#       sfrac=0, add=TRUE, scol=colBars, pch=20, yaxt="n",bty="n", ylab="",xlab="", xpd=NA, xlim=c(-130,0), lwd=2.3, cex=1.4)
